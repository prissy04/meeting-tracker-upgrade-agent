...
1. **Propose as internal tooling** — frame it as a process improvement, not a product
...
*Built with React, Anthropic Claude API, and a PM's frustration with losing action items across 47 weekly meetings.*
